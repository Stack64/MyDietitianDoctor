...
const testimonials = [
  {
    ...
    image: '👩',
    rating: 5,
    text: 'MyDietationDoctor completely transformed my life! The personalized diet plan was easy to follow, and the continuous WhatsApp support kept me motivated. I never thought losing weight could be this sustainable and enjoyable.',
    highlight: 'Lost 15kg'
  },
  {
    id: 2,
